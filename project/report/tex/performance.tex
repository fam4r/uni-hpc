...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{./graphs/omp-timings.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{./graphs/omp-speedup.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{./graphs/omp-strong.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{./graphs/omp-weak.png}
