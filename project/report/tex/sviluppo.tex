...
poiché ha coinvolto l'inizializzazione e l'interazione con il dispositivo, che
...
l'API \textit{atomicAdd}, di fatto interpretando le operazioni di conteggio e di
